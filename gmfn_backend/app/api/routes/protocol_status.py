...
def protocol_status():
    ...
    summary_details = [
        ...
        },
        {
            ...
            "label": "Loan repayment end-to-end proof",
    ...
    return {
        ...
        "truth_statement": "The protocol is late-stabilization, not finished. Partial items must keep their label until proof, phone review, and route checks are recorded.",
        "summary": summary,
        "summary_details": summary_details,
        "status_counts": status_counts,
        "next_priority": [
            "phone screenshot proof for polished routes",
            "guarantor borrower/admin invite phone proof and payout-route decision",
