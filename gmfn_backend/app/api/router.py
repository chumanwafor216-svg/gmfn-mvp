...
from app.api.routes.attention_spine import router as attention_spine_router
from app.api.routes.support_cases import router as support_cases_router
...
api_router.include_router(attention_spine_router)
