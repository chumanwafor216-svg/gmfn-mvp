...
function PreserveQueryRedirect(props: { to: string }) {
  ...
  const [basePath, baseQueryRaw = ""] = String(props.to || "").split("?");
  ...
  const nextTo = merged.toString()
    ? `${basePath}?${merged.toString()}`
    : basePath;
...
function RedirectShopGalleryAlias() {
  ...
  return (
    <Navigate
      to={`/app/shop/${encodeURIComponent(gmfnId)}${location.search || ""}`}
      replace
    />
  );
}
...
export default function App() {
  return (
    <Routes>
      ...
      <Route
        path="/my-gmfn-and-i"
        element={<PreserveQueryRedirect to="/guide" />}
      />
      ...
      >
        ...
        <Route
          path="home"
          element={<PreserveQueryRedirect to="/app/dashboard" />}
        />

        <Route path="clans" element={<ClansPage />} />
        <Route path="create-community" element={<ClansPage />} />
        <Route path="new-community" element={<ClansPage />} />
        ...
        <Route
          ...
          element={
            <PreserveQueryRedirect to="/app/my-gmfn-and-i?tab=settings" />
          }
        />
        <Route
          path="settings"
