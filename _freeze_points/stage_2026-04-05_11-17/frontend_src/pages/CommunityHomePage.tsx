...
export default function CommunityHomePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const current =
          rows.find((item: ClanItem) => getClanId(item) === storedId) ||
          rows[0] ||
          null;
  ...
  const firstCirclePreviewContacts = useMemo(() => {
    return firstCircleDraft.contacts.slice(0, 3);
  }, [firstCircleDraft]);
  ...
  return (
    ...
    >
      <PageTopNav
        sectionLabel="Community Home"
        title="Community Home"
        subtitle="Choose your current community, use invite tools, grow your trusted circle, and open the selected marketplace when you are ready."
        homeTo="/app/dashboard"
        homeLabel="Dashboard"
        backTo="/app/dashboard"
        nextLinks={[
        ...
        {!collapsed.circle ? (
          ...
          >
            <div style={innerCard("#FCFEFF")}>
              ...
              >
                Keep this first circle small, serious, and trust-based.
              </div>
