...
| `/app/identity` | Identity & Integrity page. | GSN ID, identity continuity, phone/community/bank/official-ID/recovery tasks. | Trust Passport, TrustSlip, Action Inbox. | Trust score, membership proof, or full carried evidence story. |
