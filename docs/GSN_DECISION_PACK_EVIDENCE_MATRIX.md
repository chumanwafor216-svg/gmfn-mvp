...
For housing decisions, the engine now also exposes public-safe housing-reference
readiness pointers where existing records support it: repayment follow-through,
pool/contribution activity, housing-specific Community Confirmation requests,
aggregate witness outcomes, and issue-review status. These answer the practical
landlord question, "does GSN have any society-equivalent housing-context evidence
to inspect or confirm?" They do not expose landlords, accommodation providers,
addresses, rent amounts, payment references, private witness notes, allegations,
legal tenancy status, right-to-rent checks, affordability decisions, tenancy
approval, guaranteed rent, or future conduct guarantees.
...
- Payment-discipline summaries: loan/support lifecycle, repayment, guarantor-response, pool/contribution record pointers, and housing-reference readiness pointers are now partially wired into housing, guarantor/support, and partnership packs. Still missing: mature payment-discipline summaries, lateness/consistency interpretation, actual landlord/accommodation reference records, structured housing witness answers, and public-safe issue-resolution context without acting like a credit score.
...
- Backend parity: backend Decision Pack definitions now carry the same evidence/source/gap/boundary matrix, controlled purpose-specific community confirmation prompts, public-safe declared work/service claim pointers for relevant packs, public-safe financial/support record pointers for relevant packs, aggregate housing-reference readiness pointers, aggregate guarantee/support outcome pointers, aggregate protected-trade fulfilment/correction outcome pointers, aggregate completed-work/customer-confirmation pointers, aggregate Demand Box request-outcome pointers, aggregate community witness outcome pointers, and aggregate issue-resolution pointers. The remaining work is deeper data capture: dedicated structured claims, dedicated customer-confirmed completed jobs, Demand Box responder/quote/job-completion links, landlord/accommodation reference records, mature issue-resolution summaries, mature guarantee outcome summaries, mature supplier fulfilment timelines, and richer witness-answer workflows.
