...
- Completed work records: protected-trade release/receipt records can now appear as seller-side declared work pointers, and protected-trade fulfilment/correction status is now partially wired as aggregate outcome pointers. Still missing: customer-confirmed completed-job records connected to Demand Box, quotes, Shop services, completion media, complaint detail, and mature resolution timelines.
