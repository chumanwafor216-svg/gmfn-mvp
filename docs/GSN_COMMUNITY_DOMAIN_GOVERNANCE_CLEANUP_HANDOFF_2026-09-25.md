...
Date: 2026-09-25
Status: first thirty-four cleanup slices implemented locally
...
Setup access now recommends Summary before changing setup editor authority,
keeping authority controls behind the closed access view selector.

Billing jobs now recommends Code & proof before account setup, steps, or
readiness diagnostics, keeping secondary billing jobs behind the closed selector.

Billing pay-in account now recommends Summary before account setup, keeping
GSN-admin account editing behind the closed pay-in account view selector.

Billing Code & proof now recommends Reference before code generation,
settlement checks, or proof upload, keeping each payment task behind selectors.

Operating summary now recommends Do next before status, allowance, or
permissions, keeping live-domain reference questions behind the selectors.

Activity recording now recommends Record before catalogue or recent views,
keeping the record flow staged through person, activity, and evidence.

Beneficiary outcomes now recommends Record before recent outcome views,
keeping the outcome flow staged through person, change, and proof.

Director report summaries now recommend Overview before membership, evidence, or delivery, keeping report views behind the closed report selector.
...
Trust/Evidence readiness now recommends Records before release, relay, notification, or mobility, keeping trust sub-views behind the closed view selector.
...
Service readiness now recommends Services before settings, economy, or presence, and Billing readiness now recommends Lifecycle before capacity.

Beneficiary outcome recent records now recommend Summary before confirmation, contact, delivery, or receipt.

Community Domain identity setup now leads with responsible GSN identity/personal page, then checked domain-name save, then a gated category package that collapses behind Edit package after selection.
