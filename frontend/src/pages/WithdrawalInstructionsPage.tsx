  ...
  const guidedState = useMemo(() => {
    ...
    if (!effectiveAvailableKnown) {
      return {
        ...
        detail:
          "The route should not classify this withdrawal as direct or support-backed until the effective-available reading is visible.",
      };
    }
    ...
    if (!communityRailReady) {
      return {
        ...
        detail:
          "The official community withdrawal rail must be visible and ready before the flow proceeds.",
      };
    }
    ...
    if (!requiresSupport) {
      return {
        ...
        detail:
          "No guarantor is required. You can proceed with direct withdrawal through the current community rail.",
      };
    }
    ...
    return {
      ...
      detail:
        "The requested amount is above your effective available pool. The support path should now continue until the support decision is resolved.",
    };
  }, [
    selectedClanId,
    currentGmfnId,
  ...
  async function handleLoadWithdrawalRoute() {
    ...
    try {
      ...
      if (route) {
        ...
        showNotice("error", "Community withdrawal rail is not yet returned.");
      }
    } finally {
        ...
        >
          ...
          <div>
            ...
            <div style={{ marginTop: 12, ...helperText(), maxWidth: 860 }}>
              Money Out should not behave like a loose dashboard card. Once the member
              chooses withdrawal, the flow should guide them from context and amount,
              through payout and rail confirmation, to direct result or support-backed
              continuation.
            </div>
              ...
              >
                <div style={innerCard("#FFFFFF")}>
                  ...
                  <div style={{ marginTop: 8, ...helperText(), fontSize: 13 }}>
                    {!effectiveAvailableKnown
                      ? "The route should not decide until the effective-available pool reading is visible."
                      : requiresSupport
      ...
      <section id="personal-payout-account" style={pageCard("#FFFFFF")}>
        ...
        >
          <div>
            ...
            <div style={{ marginTop: 8, ...helperText() }}>
              This is where approved withdrawal should land. It is different from the fixed community rail.
            </div>
          </div>
      ...
      <section id="community-money-out-rail" style={pageCard("#FFFFFF")}>
        ...
        >
          <div>
            ...
            <div style={{ marginTop: 8, ...helperText() }}>
              This is the official fixed community withdrawal rail. It is not the same as the personal payout destination.
            </div>
          </div>
            ...
            <div style={innerCard("#FCFEFF")}>
              ...
              {!communityRailReady ? (
                <div style={{ marginTop: 10, ...helperText(), color: "#991B1B" }}>
                  Community withdrawal rail is not visible yet. The route should not proceed until the official community rail is ready.
                </div>
              ) : (
              ...
              <div style={{ marginTop: 10, display: "grid", gap: 8 }}>
                ...
                <div style={innerCard("#FFFFFF")}>
                  ...
                  <div style={{ marginTop: 8, ...helperText(), color: "#0B1F33" }}>
                    {!effectiveAvailableKnown
                      ? "The effective-available pool reading is not visible yet, so the route should not decide the path until that reading is ready."
                      : !requiresSupport
                      ? "Because the requested amount stays inside your effective available pool, this withdrawal can proceed directly if the community rail and the personal payout destination are both ready."
                      : "Because the requested amount is above your effective available pool, the route should now continue into support. From there the support path should carry the member through readiness, fit, and deeper workbench handling instead of dropping back into unrelated surfaces."}
                  </div>
                </div>
