...
export const ACTION_TARGETS = {
  ...
  CCI: APP_ROUTES.CCI,
  COMMUNITY_CONFIRMATION_INBOX: APP_ROUTES.COMMUNITY_CONFIRMATION_INBOX,
  COMMUNITY_CONFIRMATION_POLICY: APP_ROUTES.COMMUNITY_CONFIRMATION_POLICY,
  NOTIFICATIONS: APP_ROUTES.NOTIFICATIONS,
  HELP_DESK: APP_ROUTES.HELP_DESK,
...
export const EXACT_TARGET_ALIASES: Record<string, string> = {
  ...
  "community-confirmation-inbox": ACTION_TARGETS.COMMUNITY_CONFIRMATION_INBOX,
  "community-confirmations/policy": ACTION_TARGETS.COMMUNITY_CONFIRMATION_POLICY,
  "community-confirmation-policy": ACTION_TARGETS.COMMUNITY_CONFIRMATION_POLICY,
...
const SAFE_STATIC_APP_PATHS = new Set([
  ...
  "identity",
  "community-confirmations",
  "community-confirmations/policy",
  "notifications",
  "demand-box",
  "loans",
  "loan-readiness",
